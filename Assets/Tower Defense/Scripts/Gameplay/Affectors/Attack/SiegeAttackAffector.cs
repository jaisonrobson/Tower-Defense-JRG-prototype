...
[RequireComponent(typeof(SiegeAttackController))]
[HideMonoScript]
public class SiegeAttackAffector : AttackAffector
{
    ...
    public override void PoolRetrievalAction(Poolable poolable)
    {
        ...
        GetComponent<SiegeAttackController>().PoolRetrievalAction(poolable);
    }
    public override void PoolInsertionAction(Poolable poolable)
    {
        ...
        GetComponent<SiegeAttackController>().PoolInsertionAction(poolable);
    }
    // Public (Methods) [END]
}
