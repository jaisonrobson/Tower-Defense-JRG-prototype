...
[RequireComponent(typeof(SiegeAttackEnemyDetectionColliderController))]
[HideMonoScript]
public class SiegeAttackController : AttackController
{
    ...
    private void HandleAttackMovement()
    {
        ...
        switch (GetComponent<SiegeAttackAffector>().travellingType)
        {
